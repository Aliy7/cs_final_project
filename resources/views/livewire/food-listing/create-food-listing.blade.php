...
<div class="container mx-auto p-5">
    <form wire:submit.prevent="store" class="max-w-2xl mx-auto my-10 p-6 bg-white rounded-lg shadow">
        ...
        <div class="mb-4">
            ...
            <input wire:model="name" id="name-input" type="text"
        ...
        <div class="mb-4">
            ...
            <input wire:model="ingredients" id="ingredients-input" type="text"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            ...
            <input wire:model="allergen" id="allergen-input" type="text"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            ...
            <textarea wire:model="description" id="description-input"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
        ...
        <div class="mb-4">
            <label class="flex items-center">
                <input wire:model="status" type="checkbox" class="form-checkbox h-5 w-5 text-gray-600"><span
        ...
        <div class="mb-4">
            ...
            <input wire:model.lazy="images" type="file"
                class="shadow w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                multiple>
            @error('images.*')
                <span class="text-red-500 text-xs">{{ $message }}</span>
            @enderror
        ...
        <div class="bg-blue-100 border border-blue-400 font-bold text-sky-400 px-4 py-3 rounded relative"
            role="alert">
            Add Pick Location
        </div>
        <div class="mb-4">
            ...
            <input type="text" wire:model="searchName"
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline map-input"
                id="address-input">
        </div>
        <div class="mb-4">
            <label for="address-latitude" class="block text-gray-700 text-sm font-bold mb-2">Latitude:</label>
            <input type="text" wire:model="latitude" placeholder="latitude coordiates" id="address-latitude" readonly
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
        <div class="mb-4">
            <label for="address-longitude" class="block text-gray-700 text-sm font-bold mb-2">Longitude:</label>
            <input type="text" wire:model="longitude" placeholder="longitude coordinates" id="address-longitude"
                readonly
                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
        </div>
