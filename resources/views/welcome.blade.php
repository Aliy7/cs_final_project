             ...
             @endauth
                 ...
                 <div class="my-1 flex items-center lg:my-0 lg:ml-auto">
                    {{-- <div class="flex justify-between items-center">
                        {{-- <p class="flex-1">If you have any questions, get in touch with us.</p> --}}
                        {{-- <a href="{{ route('showHelp-page') }}" class="mr-2 inline-block bg-green-400 rounded px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:text-primary-600 focus:text-primary-600 dark:text-primary-400 dark:hover:text-primary-500">Help</a>
                    </div> --}} 
                    <div class="flex justify-between items-center hover:underline uppercase mr-4 md:mr-6">
                        <strong class="mr-2 text-2xl font-bold text-black cursor-pointer hover:text-green-700 dark:text-green-400 dark:hover:text-green-500"
            ...
            <div class="mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
                <div class="grid items-center gap-12 lg:grid-cols-2">
                    <div class="mt-12 lg:mt-0">
                        ...
                        <a href="{{ route('register') }}" class="mb-2 inline-block rounded bg-blue-500 px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white" role="button">Get started</a>
                        <a href="{{ route('privacy-policy') }}" class="mb-2 inline-block rounded bg-red-500 px-8 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-white">See Privacy Policy</a>
                       
                        <div class="flex justify-between items-center">
                            <p class="flex-1 text-2xl font-italic font-bold">
                                If you have any questions, get in touch with us 
                                <a href="{{ route('contactUs-email') }}" class="text-blue-500 hover:text-blue-700">here</a>.
                            </p>
                        </div>
                        
                    </div>
                    <div class="mb-12 lg:mb-0">
                        <img src="https://tecdn.b-cdn.net/img/new/standard/city/017.jpg" class="w-full rounded-lg shadow-lg dark:shadow-black/20" alt="" />
                    </div>
                </div>
            </div>
        </div>
     ...
     <footer class="bg-sky-400 text-white px-4 py-6 w-full fixed inset-x-0 bottom-0">
        <div class="flex flex-wrap justify-between items-center max-w-screen-xl mx-auto">
            ...
            <ul class="flex flex-wrap items-center mt-3 text-sm">
                <li>
                    <a href="{{ route('privacy-policy') }}" class="hover:underline text-black font-extrabold  mr-4 md:mr-6">Privacy Policy</a>
                </li>
                <li>
                    <a href="{{ route('showHelp-page') }}" class="hover:underline text-black mr-4 md:mr-6 font-extrabold">Help</a>
                </li>
                <li>
                    <a href="{{ route('contactUs-email') }}" class="hover:underline text-black mr-4 md:mr-6 font-extrabold">Contact</a>
                </li>
            </ul>
        </div>
    </footer>
