<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <hr class="h-1 bg-gray-700 border-0">
        <!-- Name -->
        <div>
            <label for="username" class=" font-bold text-gray-700">User Name</label>
            <x-text-input id="username" class="block mt-1 w-full" type="text" name="username" :value="old('username')"
                placeholder="User Name here" required autofocus autocomplete="username" maxlength="15" />
        ...
        <div>
            ...
            <x-text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name')"
                placeholder="First Name" required autofocus autocomplete="first_name" />
        ...
        <div>
            ...
            <x-text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name')"
                placeholder="Surname" autofocus autocomplete="last_name" />
        ...
        <div>
            ...
            <x-text-input id="phone_number" class="block mt-1 w-full" type="text" name="phone_number"
                :value="old('phone_number')" placeholder="Phone Number" required autofocus autocomplete="phone_number" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full" placeholder="Enter password" type="password"
